...
const ProfilePage = () => {
    ...
    // Recommended (static/local) to avoid extra calls
    const initRecommended = useCallback(() => {
    ...
    const profileData = {
        ...
        skills: userProfile?.skills && Array.isArray(userProfile.skills) ? userProfile.skills : ['AI', 'ML Basics', 'Python'],
