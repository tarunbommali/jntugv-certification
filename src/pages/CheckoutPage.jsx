...
const CheckoutPage = () => {
            ...
            try {
                ...
                if (!foundCourse) {
                    ...
                    if (localCourse) {
                        ...
                        loadingError = "Using local demo data.";
                    }
                }
    ...
    // Ensure that 'course' object has the necessary fields (price, originalPrice, platformDiscount, taxRate)
    ...
    const handleApplyCoupon = async (e) => {
        ...
        if (!trimmed) return;
        await validateCoupon(trimmed, courseId);
    };
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="grid sm:grid-cols-3 gap-4 items-end mb-4">
                                    <div className="sm:col-span-2">
                                        ...
                                        <input type="text" value={couponCode} onChange={(e) => setCouponCode(e.target.value.toUpperCase())} placeholder="Enter coupon code (e.g., WELCOME10)" className={`${baseInputClasses} outline-none`}/>
                                    </div>
                                    <button type="button" onClick={handleApplyCoupon} className="h-12 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition">Apply</button>
                                </div>
                                ...
                                <PriceRow label={`Tax (${(taxRate * 100).toFixed(0)}%)`} value={tax} isTax={true}/>
