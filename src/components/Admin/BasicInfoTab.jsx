        ...
        <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="lg:col-span-2">
                    ...
                    <input
                        ...
                        className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.shortDescription ? 'border-red-500' : 'border-gray-300'}`}
                ...
                <div>
                    ...
                    <input
                        ...
                        className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${errors.instructor ? 'border-red-500' : 'border-gray-300'}`}
            ...
            <div className="mt-6">
                ...
                <textarea
                    ...
                    onChange={(e) => handleCourseChange('requirements', e.target.value.split('\n').filter(item => item.trim()))}
                    rows={3}
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <div className="mt-6">
                ...
                <textarea
                    ...
                    onChange={(e) => handleCourseChange('whatYouLearn', e.target.value.split('\n').filter(item => item.trim()))}
                    rows={3}
                    className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
