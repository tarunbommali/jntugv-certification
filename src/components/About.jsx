          ...
          <div className="space-y-6 prose prose-lg max-w-none text-gray-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="flex items-start space-x-3">
                ...
                <span>
                  <strong>Artificial Intelligence & Tools:</strong> Hands-on
                  experience using TensorFlow & PyTorch.
                </span>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <span>
                  <strong>Machine Learning & Deep Learning:</strong> Build
                  predictive models with real datasets.
                </span>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <span>
                  <strong>Internet of Things (IoT):</strong> Design smart
                  solutions with Arduino & Raspberry Pi.
                </span>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <span>
                  <strong>Cybersecurity & Quantum Computing:</strong> Ethical
                  hacking, network security, and quantum principles using IBM
                  Quantum Experience.
                </span>
              </div>
            </div>
            ...
            <p>
              🎯 <strong>Why Choose This Program?</strong>
              <br />
              - Hands-on projects.
              <br />
              ...
              <br />- Industry-recognized certification.
            </p>
